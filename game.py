...
from criminal import BaseCriminal, BackToFront, RandomCriminal
from student import BaseStudent, SmartStudent
...
if __name__ == "__main__":
    edge_list, begin, ends = generate_graph((7,4), (1, 50), path="game.png")

    criminals = [("BackToFront Criminal #1", BackToFront)]

    students = [("Smart Student #1", SmartStudent), ("Smart Student #2", SmartStudent), ("Smart Student #3", SmartStudent), ("Smart Student #4", SmartStudent)]
